...
body.style.backgroundImage = 'url(images/bg-slider/bg.gif)';
...
$(document).ready(function() {
	...
	$('#subscription-form').ajaxChimp({
		...
		url: 'http://enchnt.us12.list-manage.com/subscribe/post?u=45daac21bb0904d62a28de74d&amp;id=96d602b39a' /* Replace it with your custom URL inside '' */
	});
